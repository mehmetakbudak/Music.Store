...
function getPlaylist() {
  axios
    .post(`http://localhost:8544/api/Playlist/GetByFilter`, filterPlaylist)
    .then((res: any) => {
...
function getAllTracks() {
  axios
    .post(`http://localhost:8544/api/Track/GetByFilter`, filterAllTracks)
    .then((res: any) => {
...
function getSelectedTracks() {
  axios
    .post(
      `http://localhost:8544/api/Playlist/GetPlaylistTracks`,
